This repo stores almost all the precompiled libraries required for the full compilation of the [SLISC0](https://github.com/MacroUniverse/SLISC0) library, for Ubuntu20.04 on x86-64 machines.
